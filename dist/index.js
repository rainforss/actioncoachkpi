...
const kpiEntries_1 = __importDefault(require("./routes/api/kpiEntries"));
const verifyUser_1 = require("./utils/verifyUser");
const tokenRequest_1 = require("./utils/tokenRequest");
...
exports.cca = new msal.ConfidentialClientApplication(msalConfig);
